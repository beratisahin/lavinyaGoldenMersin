...
function Hakkimizda() {
  useDocumentTitle("Mersin Lavinya Golden Güzellik Merkezi");
  return (
      ...
      >
        ...
        <div className="card-body col-12" style={{ padding: "3rem" }}>
          ...
          <p class="hizmetyazi">
            ...
            yüzlü ekibi ile estetik ve güzellik sektöründe Mersin’da merkezi
            ...
            kavuşuyorsunuz. Ailenizden biri olmayı amaçlayan Mersin Lavinya Golden
          ...
          <p class="hizmetyazi">
            ...
            olmak için emin adımlarla, şehrin gözdesi Mersin merkezde ileri seviye hizmet vermektedir. Kadın ve erkeklere özel
            ayrı salonlarımızda, memnuniyet ve sonuç odaklı profesyonel
            uygulamalar yapıyoruz.
          </p>

          <p class="hizmetyazi">
            Mersin Lavinya Golden Güzellik Merkezi olarak Lazer Epilasyon, G5
            Masajı, Kavitasyon, Kirpik Lifting, Yosun Peeling,
            Hydrafacial Cilt Bakımı hizmetlerimiz mevcuttur. Kampanyalarımız ve
            detaylar için sosyal medya hesaplarımızı takipte kalın. Mersin
            ...
            müşterimize hizmet verebilmekteyiz.
                ...
                <p className="instaLink" style={{textAlign:"center",color:"gray"}}>Detaylı güncel fotoğraf ve videolar için <a className="instagram"  href="https://www.instagram.com/lavinyagoldendiyarbakir/" target="_blank">Mersin Lavinya Golden Güzellik Merkezi</a> instagram profilimizi ziyaret edebilirsiniz. </p>
