        ...
        <OwlCarousel className="owl-theme owl-roof" {...options}>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o4} className="owlCarouselImage" alt="Mersin Güzellik Merkezi" loading="lazy" title="Mersin Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o3} className="owlCarouselImage" alt="Mersin Güzellik Merkezi" loading="lazy" title="Mersin Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o1} className="owlCarouselImage" alt="Mersin Güzellik Merkezi" loading="lazy" title="Mersin Lazer Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o5} className="owlCarouselImage" alt="Mersin Güzellik Merkezi" loading="lazy" title="Mersin Lazer Epilasyon"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o6} className="owlCarouselImage" alt="Mersin Güzellik Merkezi" loading="lazy" title="Mersin Güzellik Merkezi"></img>
            ...
            <div className="item owl-slider">
                <div className="owlCarouselTemp">
                    <img src={o2} className="owlCarouselImage" alt="Mersin Güzellik Merkezi" loading="lazy" title="Mersin Güzellik Merkezi"></img>
